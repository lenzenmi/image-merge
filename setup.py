...
setup(
    ...
    url='https://github.com/lenzenmi/image-merge',
    ...
    keywords='photo merge combine image',

    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    packages=['image_merge', 'image_merge.tests'],
    ...
    package_data={
        'image_merge.tests': ['tests/images/gif.gif'],
    },
    ...
    entry_points={
        'console_scripts': [
            'image-merge=image_merge.cli:main',
        ],
    },
)